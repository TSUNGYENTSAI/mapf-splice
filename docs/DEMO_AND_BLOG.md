...
blockers; the upper loop remains available for scoped MAPF recovery. The same
routes have validated review views for `K=3`, `K=4`, and `K=5`.

The bitmap is generated rather than hand edited:
